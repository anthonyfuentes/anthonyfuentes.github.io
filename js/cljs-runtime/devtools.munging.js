...
var o29397 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29397["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29398 = temp__5733__auto____$1;
return (o29398["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27275__auto__ = f;
return (o__27275__auto__["toString"]).call(o__27275__auto__);
} else {
return "";
}
}catch (e29399){var _ = e29399;
return "";
}});
...
try{var o__27275__auto___29635 = t;
(o__27275__auto___29635["cljs$lang$ctorPrWriter"]).call(o__27275__auto___29635,t,writer);
}catch (e29401){var __29636 = e29401;
}
...
var char_code = (function (){var o__27275__auto__ = (new String(char$));
return (o__27275__auto__["charCodeAt"]).call(o__27275__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27275__auto__ = String;
return (o__27275__auto__["fromCharCode"]).call(o__27275__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29402 = num_code;
switch (G__29402) {
case (1):
return (185);
...
var o__27275__auto__ = String;
return (o__27275__auto__["fromCharCode"]).call(o__27275__auto__,superscript_code);
});
/**
...
}catch (e29404){var _e__27307__auto__ = e29404;
return false;
}})())){
...
var vec__29405 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29405,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29408 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29408["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29409 = temp__5733__auto____$1;
return (o29409["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29412){
var vec__29413 = p__29412;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29413,(0),null);
...
var G__29651 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29652 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29651;
remaining_tokens = G__29652;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29410){
var G__29411 = cljs.core.first(seq29410);
var seq29410__$1 = cljs.core.next(seq29410);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29411,seq29410__$1);
}));
...
var vec__29426 = cljs.core.split_with((function (p1__29425_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29425_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29426,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29426,(1),null);
...
var vec__29443 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29657 = cljs.core.rest(remaining_tokens);
var G__29658 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29657;
name_tokens = G__29658;
continue;
} else {
...
var vec__29454 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29454,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29454,(1),null);
var vec__29457 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29457,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29457,(1),null);
var vec__29460 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29460,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29460,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29460,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29460,(3),null);
...
var vec__29465 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29465,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29471 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(1),null);
var vec__29474 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29474,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29474,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29490 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29490) : devtools.munging.parse_fn_info_deep.call(null,G__29490));
})()));
}
} else {
return fn_info;
...
var G__29674 = (arity + (1));
var G__29675 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29497){
var vec__29498 = p__29497;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29498,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29498,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29516_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29516_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29517_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29517_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29534){
var vec__29536 = p__29534;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29536,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29530){
var G__29531 = cljs.core.first(seq29530);
var seq29530__$1 = cljs.core.next(seq29530);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29531,seq29530__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29548__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29548__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29548__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29548__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29549 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(5),null);
...
var o__27275__auto__ = f;
return (o__27275__auto__["getBasis"]).call(o__27275__auto__);
});
/**
...
}catch (e29555){var _e__27307__auto__ = e29555;
...
var G__29684 = (obj[cljs.core.first(path)]);
var G__29685 = cljs.core.rest(path);
obj = G__29684;
path = G__29685;
continue;
} else {
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29590){
var vec__29591 = p__29590;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29591,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29591,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29591,(2),null);
...
var post_process = (function (p__29607){
var vec__29608 = p__29607;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29608,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29608,(1),null);
