...
var G__37755 = o;
goog.object.set(G__37755,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37756 = o;
goog.object.set(G__37756,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37776__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__37776 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__37777__i = 0, G__37777__a = new Array(arguments.length -  0);
while (G__37777__i < G__37777__a.length) {G__37777__a[G__37777__i] = arguments[G__37777__i + 0]; ++G__37777__i;}
  args = new cljs.core.IndexedSeq(G__37777__a,0,null);
} 
return G__37776__delegate.call(this,args);};
G__37776.cljs$lang$maxFixedArity = 0;
G__37776.cljs$lang$applyTo = (function (arglist__37778){
var args = cljs.core.seq(arglist__37778);
return G__37776__delegate(args);
});
G__37776.cljs$core$IFn$_invoke$arity$variadic = G__37776__delegate;
return G__37776;
})()
;
} else {
...
var G__37757 = props;
var G__37757__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37757,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37757);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37757__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37758 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37758,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37758;
}
})(),id_class);
...
var G__37759 = (cljs.core.count(argv) - first_child);
switch (G__37759) {
case (0):
...
var vec__37760 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37760,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37760,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37760,(2),null);
...
var temp__5739__auto___37786 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37786 == null)){
} else {
var key_37787 = temp__5739__auto___37786;
(jsprops.key = key_37787);
}
...
var temp__5739__auto___37788 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37788 == null)){
} else {
var key_37789 = temp__5739__auto___37788;
(jsprops.key = key_37789);
}
...
var temp__5739__auto___37790 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___37790 == null)){
} else {
var key_37791 = temp__5739__auto___37790;
(jsprops.key = key_37791);
}
...
var temp__5739__auto___37792 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37792 == null)){
} else {
var key_37793 = temp__5739__auto___37792;
(jsprops.key = key_37793);
}
...
var temp__5739__auto___37794 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37794 == null)){
} else {
var key_37795 = temp__5739__auto___37794;
(jsprops.key = key_37795);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37763_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37763_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37764 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37764,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37764,(1),null);
...
break;
default:
var G__37797 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37798 = compiler;
v = G__37797;
compiler = G__37798;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37770 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37770 = (function (opts,id,fn_to_element,meta37771){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta37771 = meta37771;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template37770.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37772,meta37771__$1){
var self__ = this;
var _37772__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37770(self__.opts,self__.id,self__.fn_to_element,meta37771__$1));
}));

(reagent.impl.template.t_reagent$impl$template37770.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37772){
var self__ = this;
var _37772__$1 = this;
return self__.meta37771;
}));

(reagent.impl.template.t_reagent$impl$template37770.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37770.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37770.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37770.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37770.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta37771","meta37771",-1993212653,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37770.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37770.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37770");

(reagent.impl.template.t_reagent$impl$template37770.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template37770");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37770.
 */
reagent.impl.template.__GT_t_reagent$impl$template37770 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37770(opts__$1,id__$1,fn_to_element__$1,meta37771){
return (new reagent.impl.template.t_reagent$impl$template37770(opts__$1,id__$1,fn_to_element__$1,meta37771));
});

}

return (new reagent.impl.template.t_reagent$impl$template37770(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
