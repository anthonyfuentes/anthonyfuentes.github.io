...
var G__29939 = (i__4737__auto___29936 + (1));
i__4737__auto___29936 = G__29939;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29771){
var G__29772 = cljs.core.first(seq29771);
var seq29771__$1 = cljs.core.next(seq29771);
var G__29773 = cljs.core.first(seq29771__$1);
var seq29771__$2 = cljs.core.next(seq29771__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29772,G__29773,seq29771__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29801_SHARP_){
return (!((cljs.core.meta(p1__29801_SHARP_) == null)));
})))){
...
var map__29876 = opts;
var map__29876__$1 = (((((!((map__29876 == null))))?(((((map__29876.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29876.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29876):map__29876);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29876__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29880){var _e__27307__auto__ = e29880;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e29882){var _e__27307__auto__ = e29882;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29885 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29886 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29886);

try{var map__29887 = opts;
var map__29887__$1 = (((((!((map__29887 == null))))?(((((map__29887.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29887.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29887):map__29887);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29887__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29885);
}});
...
var temp__5733__auto___29989 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29989)){
var managed_print_level_29990 = temp__5733__auto___29989;
var _STAR_print_level_STAR__orig_val__29933_29991 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29934_29992 = managed_print_level_29990;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29934_29992);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29930_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29930_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29933_29991);
}} else {
job_fn();
}
